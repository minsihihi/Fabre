const API_BASE_URL = "https://13.209.19.146:3000/api"; // 백엔드 API URL
...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  // 메인화면 버튼 이벤트
  document
    .getElementById("login-page-btn")
    .addEventListener("click", () => showPage("login"));
  document
    .getElementById("register-page-btn")
